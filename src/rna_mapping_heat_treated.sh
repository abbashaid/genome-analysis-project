...
#SBATCH -c 16
#SBATCH -t 02:00:00
#SBATCH -J rna_mapping_heat_treated
...
OUT_DIR=$PROJ_DIR/out/rna_mapping_heat_treated
mkdir -p $OUT_DIR

INDEX_PREFIX=$TMP/chr3_hisat2_index
...
echo "Completed HISAT2 mapping for all heat treated samples"
